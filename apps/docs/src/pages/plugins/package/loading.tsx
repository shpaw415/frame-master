		...
		<div className="min-h-screen bg-theme-bg flex items-center justify-center overflow-hidden">
			<div className="relative">
				...
				<div className="absolute inset-0 -z-10">
					...
					<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-purple-500/20 rounded-full blur-3xl animate-pulse delay-100"></div>
				</div>

				{/* Loading Content */}
				<div className="text-center">
					{/* Animated Plugin Icon */}
					<div className="mb-8 relative">
						<div className="w-24 h-24 mx-auto bg-linear-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-2xl shadow-blue-500/50 animate-bounce">
					...
					<p className="text-theme-muted mb-8">
						Fetching information from the marketplace...
					</p>

					{/* Progress Bar */}
					<div className="w-64 h-2 mx-auto bg-theme-input rounded-full overflow-hidden">
						<div className="h-full bg-linear-to-r from-blue-500 to-purple-500 rounded-full animate-loading-bar"></div>
					</div>
