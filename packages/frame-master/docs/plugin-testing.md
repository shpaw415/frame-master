...
- Introduced as a top-level **`test-suite/`** product in Frame-Master (see package export `./testing`).
- Source of truth in the monorepo: [`test-suite/`](https://github.com/shpaw415/frame-master/tree/main/test-suite)
- Short author README: [`test-suite/README.md`](https://github.com/shpaw415/frame-master/blob/main/test-suite/README.md)
