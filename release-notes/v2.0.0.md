...
- **21% reduction** in length (685 → 532 lines) while preserving all critical information
...
1. Replace `import config from "frame-master/config"` with `import { getConfig } from "frame-master/config"`
...
```bash
# Update to v2.0.0
bun add -g frame-master@2.0.0

# Or in your project
bun add frame-master@2.0.0
```
...
- [Full Changelog](https://github.com/shpaw415/frame-master/compare/v1.1.0...v2.0.0)
