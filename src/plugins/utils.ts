...
class IPCManager<ProcessType extends IPCProcessType = IPCProcessType> {
	 ...
	 */
	public async send<RequestData = unknown, ResponseData = unknown>(
		to: IPCProcessType,
		id: string,
		data: RequestData,
	 ...
	 */
	public onMessage<RequestData = unknown, ResponseData = unknown>(
		id: string,
		callback: (
			message: RequestData,
			from: IPCProcessType,
	...
	private respond<T>(requestID: string, to: IPCProcessType, data: T) {
...
export function serializeError(
	...
	let cause: ErrorObject["cause"] | undefined;
